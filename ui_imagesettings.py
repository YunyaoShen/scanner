...
class Ui_ImageSettingsUi(object):
    def setupUi(self, ImageSettingsUi):
        ...
        ImageSettingsUi.resize(377, 315)
    ...
    def retranslateUi(self, ImageSettingsUi):
        ...
        self.groupBox_2.setTitle(QCoreApplication.translate("ImageSettingsUi", u"\u56fe\u50cf\u8bbe\u7f6e", None))
        self.label_6.setText(QCoreApplication.translate("ImageSettingsUi", u"\u56fe\u50cf\u683c\u5f0f", None))
        self.label_8.setText(QCoreApplication.translate("ImageSettingsUi", u"\u5206\u8fa8\u7387", None))
    # retranslateUi
