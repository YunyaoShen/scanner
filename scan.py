...
class Scan(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        # image codecs
        self._ui.imageCodecBox.addItem("默认路径")
        ...
        self._ui.imageResolutionBox.addItem("5x")
        self._ui.imageResolutionBox.addItem("10x")

        self._ui.imageResolutionBox.addItem("20x")

        self._ui.imageResolutionBox.addItem("40x")
