...
UVCHAM_CODEC               = 0x01000000    # codec:
                                           #    Can be changed only BEFORE Uvcham_start. After Uvcham_start, the codec can no longer changed.
...
UVCHAM_RES                 = 0x10000000    # resolution:
                                           #    Can be changed only BEFORE Uvcham_start. After Uvcham_start, the resolution can no longer changed.
...
class Uvcham:
    ...
    @classmethod
    def Version(cls):
        """get the version of this dll, which is: 1.23274.20230903"""
        cls.__initlib()
